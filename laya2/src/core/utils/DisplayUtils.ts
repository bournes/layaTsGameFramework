...
* QQ:8510001
*/
export default class DisplayUtils extends BaseClass {
    private _templetCache;
    ...
    createBitmapText(xPos, yPos, fontUrl, fontPngUrl, fontName, parent = null, width = 0, align = Laya.Stage.ALIGN_CENTER) {
        //注册font字体到Text中
        AppL.FontManager.register(fontUrl, fontPngUrl, fontName);
    ...
    createAsynSkeleton(skKey, type, callback = null, thisObj = null) {
        ...
        if (templet) {
            ...
            AppL.ResourceUtils.loadResource(res, compleSk, null, null);
        }
    ...
    imageUrlLoad(url, callback, thisObj) {
        ...
        AppL.ResourceUtils.loadResource(res, callback, null, thisObj);
    }
